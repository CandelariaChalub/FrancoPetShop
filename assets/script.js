    ...
    created() {
        ...
        .then((data) => {
            ...
            if (document.title == "Juguetes"){
                this.productos = data.filter(producto => producto.categoria == "jugueteria")
            }
            if (document.title == "Farmacia"){
                this.productos = data.filter(producto => producto.categoria == "farmacia")
            }
...
filtrarPorBusqueda(){
    ...
    if (inputBusqueda =! ""){
        if(document.title == "Franco PetShop"){
            let coincidencia = this.auxProductos.find(produc => produc.producto.toLowerCase().includes(this.inputBusqueda.toLowerCase()) || produc.descripcion.toLowerCase().includes(this.inputBusqueda.toLowerCase()))
            if (coincidencia.tipo == "Medicamento"){
                window.location.replace("./farmacia.html")
                this.productos = this.auxProductos.filter(producto => producto.producto.toLowerCase().includes(this.inputBusqueda.toLowerCase()) || producto.descripcion.toLowerCase().includes(this.inputBusqueda.toLowerCase()))
            }else {
